...
import './assets/css/jQueryUi.min.css';
...
const MainPage = () => (
  <>
        ...
        <div className="container">
          <div className="st-top-header-in">
            <ul className="st-top-header-list">
              ...
              <li>
                <svg enableBackground="new 0 0 512.021 512.021" viewBox="0 0 512.021 512.021" xmlns="http://www.w3.org/2000/svg">
                  <g>
            ...
            <a href="#appointment" className="st-top-header-btn st-smooth-move">
              Appointment
            </a>
          </div>
        </div>
          ...
          <div className="st-main-header-in">
            <div className="st-main-header-left">
              <a className="st-site-branding" href="index.html">
                <img src="/img/logo.png" alt="Nischinto" />
              </a>
            </div>
            <div className="st-main-header-right">
              <div className="st-nav">
                <ul className="st-nav-list st-onepage-nav">
                  ...
                  <li>
                    <a href="#department" className="st-smooth-move">
                      Department
                    </a>
                  </li>
                  <li>
                    <a href="#doctors" className="st-smooth-move">
                      Doctors
                    </a>
                  </li>
                  <li>
                    <a href="#gallery" className="st-smooth-move">
                      Gallery
                    </a>
                  </li>
                  <li>
                    <a href="#price" className="st-smooth-move">
                      Pricing
                    </a>
                  </li>
                  <li className="menu-item-has-children">
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="blog-details-no-sidebar.html">Blog Details No Sidebar</a>
                      </li>
                    </ul>
                  </li>
                  <li>
    ...
    <div className="st-content">
      <div className="st-height-b45 st-height-lg-b80" />

      <div className="st-hero-wrap overflow-hidden st-gradient">
          ...
          <div className="container">
            <div className="st-hero-text st-white">
              ...
              <div className="st-hero-subtitle">
                The art of medicine consists in amusing the patient while nature cures the disease. <br />
                Treatment without prevention is simply unsustainable.
              </div>
              <div className="st-hero-btn-group">
                <a href="#appointment" className="st-btn st-style1 st-color5 st-smooth-move">
                  Appointment
                </a>
                <a href="#about" className="st-btn st-style2 st-color2 st-smooth-move">
                  About Us
                </a>
              </div>
            </div>
        ...
        <div className="st-slider st-style1 st-hero-slider1" id="home">
          <div className="slick-container" data-autoplay={1} data-loop={1} data-speed={800} data-autoplay-timeout={1000} data-center={0} data-slides-per-view={1} data-fade-slide={1}>
            <div className="slick-wrapper">
              ...
              <div className="slick-slide-in">
                <div className="st-hero-img">
                  <img src="/img/hero-img1.png" alt="Hero img" />
                </div>
              </div>
              <div className="slick-slide-in">
                <div className="st-hero-img">
                  <img src="/img/hero-img2.png" alt="Hero img" />
                </div>
              </div>
            </div>
          </div>

          <div className="pagination st-style1 container st-hidden" />
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="st-iconbox st-style1">
                <div className="st-iconbox-icon st-purple-box">
                ...
                <h2 className="st-iconbox-title">Qualified Doctors</h2>
                <div className="st-iconbox-text">Lorem ipsum dolor sit amet consectet adipis sed do eiusmod tempor inc ididunt utid labore.</div>
              </div>
            ...
            <div className="col-lg-4">
              <div className="st-iconbox st-style1">
                <div className="st-iconbox-icon st-green-box">
                  <svg enableBackground="new 0 0 511.988 511.988" viewBox="0 0 511.988 511.988" xmlns="http://www.w3.org/2000/svg">
                    <g>
                ...
                <h2 className="st-iconbox-title">24 Hours Service</h2>
                <div className="st-iconbox-text">Lorem ipsum dolor sit amet consectet adipis sed do eiusmod tempor inc ididunt utid labore.</div>
              </div>
              <div className="st-height-b0 st-height-lg-b30" />
            </div>
            ...
            <div className="col-lg-4">
              <div className="st-iconbox st-style1">
                <div className="st-iconbox-icon st-red-box">
                ...
                <h2 className="st-iconbox-title">Need Emergency</h2>
                <div className="st-iconbox-text">Lorem ipsum dolor sit amet consectet adipis sed do eiusmod tempor inc ididunt utid labore.</div>
              </div>
              <div className="st-height-b0 st-height-lg-b30" />
            </div>
      ...
      <section className="st-about-wrap" id="about">
        <div className="st-shape-bg">
          <img src="/img/shape/about-bg-shape.svg" alt="shape" />
        </div>
        <div className="st-height-b120 st-height-lg-b50" />
        <div className="container">
          <div className="st-section-heading st-style1">
            <h2 className="st-section-heading-title">Who We Are</h2>
            ...
            <div className="st-section-heading-subtitle">
              ...
              <div className="st-vertical-middle">
                <div className="st-vertical-middle-in">
                  <div className="st-text-block st-style1">
                    <h2 className="st-text-block-title">A hospital is a health care institution providing patient treatment with specialized medical</h2>
                    ...
                    <div className="st-text-block-avatar">
                      ...
                      <div className="st-avatar-info">
                        <h4 className="st-avatar-name">David Ambrose</h4>
                        <div className="st-avatar-designation">Founder &amp; Director</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="st-shedule-wrap">
                <div className="st-shedule">
                  ...
                  <ul className="st-shedule-list">
                    <li>
                      <div className="st-shedule-left">Monday</div>
                      <div className="st-shedule-right">8:00am–7:00pm </div>
                    </li>
                    <li>
                      <div className="st-shedule-left">Tuesday</div>
                      <div className="st-shedule-right">9:00am–6:00pm </div>
                    </li>
                    <li>
                      <div className="st-shedule-left">Wednesday</div>
                      <div className="st-shedule-right">9:00am–6:00pm </div>
                    </li>
                    <li>
                      <div className="st-shedule-left">Thursday</div>
                      <div className="st-shedule-right">8:00am–7:00pm</div>
                    </li>
                    <li>
                      <div className="st-shedule-left">Friday</div>
                      <div className="st-shedule-right">8:00am–7:00pm</div>
                    </li>
                    <li>
                      <div className="st-shedule-left">Saturday</div>
                      <div className="st-shedule-right">9:00am–5:00pm</div>
                    </li>
                    <li>
                      <div className="st-shedule-left">Sunday</div>
                      <div className="st-shedule-right">9:00am–3:00pm</div>
                    </li>
                  </ul>
                  <div className="st-height-b25 st-height-lg-b25" />
      ...
      <section id="department">
        ...
        <div className="container">
          <div className="st-section-heading st-style1">
            <h2 className="st-section-heading-title">Our department</h2>
            <div className="st-seperator">
              <div className="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" />
              <div className="st-seperator-center">
                <img src="/img/icons/4.png" alt="icon" />
        ...
        <div className="container">
          <div className="st-tabs st-fade-tabs st-style1">
            <ul className="st-tab-links st-style1 st-mp0">
              <li className="st-tab-title active ">
                <a href="#Crutches" className="st-blue-box">
                  <svg enableBackground="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    <g>
                      <path d="m30.991 30h30v251.001l60.004 80.005v150.994h30v-150.994l60.004-80.005v-251.001h30v-30h-210.008zm60 231.001v-70.006h90.008v70.006zm75.008 30-30.004 40.005-30.004-40.005zm15-130.006h-90.008v-130.995h90.008z" />
                      <path d="m481.009 0h-210.008v30h30v251.001l60.004 80.005v150.994h30v-150.994l60.004-80.005v-251.001h30zm-150.008 261.001v-70.006h90.008v70.006zm75.008 30-30.004 40.005-30.004-40.005zm15-130.006h-90.008v-130.995h90.008z" />
                    </g>
                  </svg>
                  <span>Crutches</span>
                </a>
              </li>
              <li className="st-tab-title">
                <a href="#X-ray" className="st-red-box">
                  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 480 480" xmlSpace="preserve">
                    <g>
                      <path
              ...
              <li className="st-tab-title">
                <a href="#Pulmonary" className="st-green-box">
                  <svg enableBackground="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    <g>
              ...
              <li className="st-tab-title">
                <a href="#Cardiology" className="st-dip-blue-box">
              ...
              <li className="st-tab-title">
                <a href="#DentalCare" className="st-orange-box">
                  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 480.335 480.335" xmlSpace="preserve">
                    <g>
                      <path
              ...
              <li className="st-tab-title">
                <a href="#Neurology" className="st-gray-box">
            ...
            <div className="tab-content">
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="st-imagebox-img">
                        <img src="/img/crutches.png" alt="service" />
                      </div>
                      <div className="st-height-b0 st-height-lg-b30" />
                    </div>
                    <div className="col-lg-6">
                      <div className="st-vertical-middle">
                        <div className="st-vertical-middle-in">
                          <div className="st-imagebox-info">
                            ...
                            <h4 className="st-imagebox-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magni nemo libero debitis vitae sapiente quos. </h4>
                            <div className="st-imagebox-text">Oillum abrem deleniti adipisci suscipit dignissimos. remaining essentially unchanged. It was popularised in the with the . Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem ipsum dolor sit amet consectetur adipisicing elit.</div>
                          </div>
                          <div className="st-imagebox-btn">
                            <a href="#" className="st-btn st-style1 st-size-medium st-color1">
                              Read More
                            </a>
                          </div>
                        </div>
              ...
              <div id="X-ray" className="st-tab">
                <div className="st-imagebox st-style2">
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="st-imagebox-img">
                        <img src="/img/xray.png" alt="service" />
                      </div>
                      <div className="st-height-b0 st-height-lg-b30" />
                    </div>
                    <div className="col-lg-6">
              ...
              <div id="Pulmonary" className="st-tab">
                <div className="st-imagebox st-style2">
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="st-imagebox-img">
                        <img src="/img/pulmonary.png" alt="service" />
                      </div>
                      <div className="st-height-b0 st-height-lg-b30" />
                    </div>
                    <div className="col-lg-6">
              ...
              <div id="Cardiology" className="st-tab">
                <div className="st-imagebox st-style2">
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="st-imagebox-img">
                        <img src="/img/cardiology.png" alt="service" />
                      </div>
                      <div className="st-height-b0 st-height-lg-b30" />
                    </div>
                    <div className="col-lg-6">
              ...
              <div id="DentalCare" className="st-tab">
                <div className="st-imagebox st-style2">
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="st-imagebox-img">
                        <img src="/img/dental-care.png" alt="service" />
                      </div>
                      <div className="st-height-b0 st-height-lg-b30" />
                    </div>
                    <div className="col-lg-6">
              ...
              <div id="Neurology" className="st-tab">
                <div className="st-imagebox st-style2">
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="st-imagebox-img">
                        <img src="/img/neurology.png" alt="service" />
                      </div>
                      <div className="st-height-b0 st-height-lg-b30" />
                    </div>
                    <div className="col-lg-6">
      ...
      <section id="appointment" className="st-shape-wrap st-gray-bg">
        <div className="st-shape4">
          <img src="/img/shape/section_shape.png" alt="shape1" />
        </div>
        <div className="st-shape6">
          <img src="/img/shape/contact-shape3.svg" alt="shape3" />
        </div>
        <div className="st-height-b120 st-height-lg-b80" />
        <div className="container">
          <div className="st-section-heading st-style1">
            <h2 className="st-section-heading-title">Make an appointment</h2>
            <div className="st-seperator">
              <div className="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" />
              <div className="st-seperator-center">
                <img src="/img/icons/4.png" alt="icon" />
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <form method="POST" action="assets/php/appointment.php" className="st-appointment-form" id="appointment-form">
                <div id="st-alert1" />
                <div className="row">
                  <div className="col-lg-6">
                  ...
                  <div className="col-lg-6">
                    <div className="st-form-field st-style1">
                      ...
                      <div className="st-custom-select-wrap">
                        <select name="udepartment" id="udepartment" className="st_select1" data-placeholder="Select department">
                          <option />
                  ...
                  <div className="col-lg-6">
                    <div className="st-form-field st-style1">
                      <label>Doctor</label>
                      <div className="st-custom-select-wrap">
                        <select name="udoctor" className="st_select1" id="udoctor" data-placeholder="Select doctor">
                          <option />
                  ...
                  <div className="col-lg-12">
                    <div className="st-form-field st-style1">
                      <label>Message</label>
                      <textarea cols={30} rows={10} id="umsg" name="umsg" placeholder="Write something here..." defaultValue={''} />
                    </div>
                  </div>
                  <div className="col-lg-12">
                    <button className="st-btn st-style1 st-color1 st-size-medium" type="submit" id="appointment-submit" name="submit">
                      Appointment
                    </button>
                  </div>
                </div>
      ...
      <section id="doctors">
        ...
        <div className="container">
          <div className="st-section-heading st-style1">
            <h2 className="st-section-heading-title">Meet our specialists</h2>
            <div className="st-seperator">
              <div className="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" />
              <div className="st-seperator-center">
                <img src="/img/icons/4.png" alt="icon" />
        ...
        <div className="container">
          <div className="st-slider st-style2">
            <div className="slick-container" data-autoplay={0} data-loop={1} data-speed={600} data-center={0} data-slides-per-view="responsive" data-xs-slides={1} data-sm-slides={2} data-md-slides={3} data-lg-slides={4} data-add-slides={4}>
              <div className="slick-wrapper">
                <div className="slick-slide-in">
                  <div className="st-member st-style1 st-zoom">
                    <div className="st-member-img">
                      <img src="/img/member1.jpg" alt="" className="st-zoom-in" />
                      <a className="st-doctor-link" href="doctor-profile.html">
                        <i className="fas fa-link" />
                      </a>
                      <div className="st-member-social-wrap">
                        <img src="/img/shape/member-shape.svg" alt="shape" className="st-member-social-bg" />
                    ...
                    <div className="st-member-meta">
                      <div className="st-member-meta-in">
                        <h3 className="st-member-name">
                          <a href="doctor-profile.html">Dr. Philip Bailey</a>
                        </h3>
                        <div className="st-member-designation">Urology</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="slick-slide-in">
                  <div className="st-member st-style1 st-zoom">
                    <div className="st-member-img">
                      <img src="/img/member2.jpg" alt="member2" className="st-zoom-in" />
                      <a className="st-doctor-link" href="doctor-profile.html">
                        <i className="fas fa-link" />
                      </a>
                      <div className="st-member-social-wrap">
                    ...
                    <div className="st-member-meta">
                      <div className="st-member-meta-in">
                        <h3 className="st-member-name">
                          <a href="doctor-profile.html">Dr. Vera Hasson</a>
                        </h3>
                        <div className="st-member-designation">Cardiology</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="slick-slide-in">
                  <div className="st-member st-style1 st-zoom">
                    <div className="st-member-img">
                      <img src="/img/member3.jpg" alt="member3" className="st-zoom-in" />
                      <a className="st-doctor-link" href="doctor-profile.html">
                        <i className="fas fa-link" />
                      </a>
                      <div className="st-member-social-wrap">
                    ...
                    <div className="st-member-meta">
                      <div className="st-member-meta-in">
                        <h3 className="st-member-name">
                          <a href="doctor-profile.html">Dr. Matthew Hill</a>
                        </h3>
                        <div className="st-member-designation">Neurosurgery</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="slick-slide-in">
                  <div className="st-member st-style1 st-zoom">
                    <div className="st-member-img">
                      <img src="/img/member4.jpg" alt="member4" className="st-zoom-in" />
                      <a className="st-doctor-link" href="doctor-profile.html">
                        <i className="fas fa-link" />
                      </a>
                      <div className="st-member-social-wrap">
                    ...
                    <div className="st-member-meta">
                      <div className="st-member-meta-in">
                        <h3 className="st-member-name">
                          <a href="doctor-profile.html">Dr. Jeanette Hoff</a>
                        </h3>
                        <div className="st-member-designation">Surgery</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="pagination st-style1 st-flex st-hidden" />
          ...
          <div className="st-portfolio-wrapper">
            ...
            <div className="st-isotop st-style1 st-port-col-3 st-has-gutter st-lightgallery">
              ...
              <div className="st-isotop-item cardiology urology">
                <a href="/img/project1_lg.jpg" className="st-project st-zoom st-lightbox-item st-link-hover-wrap">
              ...
              <div className="st-isotop-item cardiology neurology">
                <a href="/img/project2_lg.jpg" className="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                  <div className="st-project-img st-zoom-in">
              ...
              <div className="st-isotop-item urology pulmonary">
                <a href="/img/project3_lg.jpg" className="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                  <div className="st-project-img st-zoom-in">
              ...
              <div className="st-isotop-item neurology traumatology">
                <a href="/img/project4_lg.jpg" className="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                  <div className="st-project-img st-zoom-in">
              ...
              <div className="st-isotop-item cardiology pulmonary">
                <a href="/img/project5_lg.jpg" className="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                  <div className="st-project-img st-zoom-in">
                    <img src="/img/project5.jpg" alt="project5" />
                  </div>
                  <span className="st-link-hover">
                    <i className="fas fa-arrows-alt" />
                  </span>
              ...
              <div className="st-isotop-item neurology traumatology">
                <a href="/img/project6_lg.jpg" className="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                  <div className="st-project-img st-zoom-in">
                    <img src="/img/project6.jpg" alt="project6" />
                  </div>
                  <span className="st-link-hover">
                    <i className="fas fa-arrows-alt" />
                  </span>
              ...
              <div className="st-isotop-item urology pulmonary traumatology">
                <a href="/img/project7_lg.jpg" className="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                  <div className="st-project-img st-zoom-in">
                    <img src="/img/project7.jpg" alt="project6" />
                  </div>
                  <span className="st-link-hover">
                    <i className="fas fa-arrows-alt" />
                  </span>
      ...
      <section className="st-before-after-section st-dynamic-bg st-bg" data-src="/img/before-after-bg.jpg">
        <div className="st-height-b120 st-height-lg-b80" />
        <div className="container">
          <div className="st-section-heading st-style1">
            <h2 className="st-section-heading-title">Before and after procedures</h2>
            <div className="st-seperator">
              <div className="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" />
              <div className="st-seperator-center">
                <img src="/img/icons/4.png" alt="icon" />
          ...
          <div className="container">
            <div className="st-before-after-in">
              <div className="st-before-after">
                <div className="st-after st-single-slide st-dynamic-bg" data-src="/img/after.jpg" />
                <div className="st-before st-single-slide st-dynamic-bg" data-src="/img/before.jpg" />
                <div className="st-handle-before-after">
                  <span />
                </div>
              </div>
            </div>
      ...
      <section>
        ...
        <div className="container">
          <div className="st-section-heading st-style1">
            <h2 className="st-section-heading-title">What peoble say?</h2>
            <div className="st-seperator">
              <div className="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" />
              <div className="st-seperator-center">
                <img src="/img/icons/4.png" alt="icon" />
        ...
        <div className="container">
          <div className="st-slider st-style2 st-pricing-wrap">
              ...
              <div className="slick-wrapper">
                  ...
                  <div className="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                    <div className="st-testimonial-info">
                      <div className="st-testimonial-img">
                        <img src="/img/avatar2.png" alt="avatar1" />
                      </div>
                      <div className="st-testimonial-meta">
                        <h4 className="st-testimonial-name">Ralph Jones</h4>
                        <div className="st-testimonial-designation">UX Designer</div>
                      </div>
                    </div>
                    <div className="st-testimonial-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum the industry's standard dummy text.</div>
                ...
                <div className="slick-slide-in">
                  <div className="st-testimonial st-style1">
                    <div className="st-testimonial-info">
                      <div className="st-testimonial-img">
                        <img src="/img/avatar3.png" alt="avatar2" />
                      </div>
                      <div className="st-testimonial-meta">
                        <h4 className="st-testimonial-name">Francis Jara</h4>
                        <div className="st-testimonial-designation">Biographer</div>
                      </div>
                    </div>
                    <div className="st-testimonial-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum the industry's standard dummy text.</div>
                    <div className="st-quote">
                ...
                <div className="slick-slide-in">
                  <div className="st-testimonial st-style1 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                    <div className="st-testimonial-info">
                      <div className="st-testimonial-img">
                        <img src="/img/avatar4.png" alt="avatar3" />
                      </div>
                      <div className="st-testimonial-meta">
                        <h4 className="st-testimonial-name">David Baer</h4>
                        <div className="st-testimonial-designation">Executive</div>
                      </div>
                    </div>
                    <div className="st-testimonial-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum the industry's standard dummy text.</div>
                    <div className="st-quote">
          ...
          <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="st-funfact st-style1">
                    <div className="st-funfact-icon st-dip-blue-box">
                      <svg enableBackground="new 0 0 511.619 511.619" viewBox="0 0 511.619 511.619" xmlns="http://www.w3.org/2000/svg">
                        <g>
            ...
            <div className="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
              <div className="st-video-block st-style1 st-zoom">
                <div className="st-video-block-img st-zoom-in st-dynamic-bg" data-src="/img/video-block-img.jpg" />
                <a href="https://www.youtube.com/embed/jRcfE2xxSAw?autoplay=1" className="st-play-btn st-style1 st-video-open">
                  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 336 336" xmlSpace="preserve">
                    <g>
                      <path
      ...
      <section id="price">
        ...
        <div className="container">
          <div className="st-section-heading st-style1">
            <h2 className="st-section-heading-title">Show your pricing plans</h2>
            <div className="st-seperator">
              <div className="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" />
              <div className="st-seperator-center">
                <img src="/img/icons/4.png" alt="icon" />
            ...
            <div className="slick-container" data-autoplay={0} data-loop={1} data-speed={600} data-center={0} data-slides-per-view="responsive" data-xs-slides={1} data-sm-slides={2} data-md-slides={3} data-lg-slides={3} data-add-slides={3}>
              <div className="slick-wrapper">
                <div className="slick-slide-in">
                  <div className="st-pricing-table st-style1">
                    <div className="st-pricing-head">
                      <h2 className="st-price">$39</h2>
                      <img src="/img/shape/price-shape.svg" alt="shape" className="st-pricing-head-shape" />
                    </div>

                    <div className="st-pricing-feature">
                      <h2 className="st-pricing-feature-title">Blood Test</h2>
                      ...
                      <div className="st-pricing-btn">
                        <a href="#" className="st-btn st-style2 st-color1 st-size-medium">
                          Contact Now
                        </a>
                      </div>
                      <div className="st-height-b30 st-height-lg-b30" />
                ...
                <div className="slick-slide-in">
                  <div className="st-pricing-table st-style1">
                    <div className="st-pricing-head">
                      <h2 className="st-price">$150</h2>
                      <img src="/img/shape/price-shape.svg" alt="shape" className="st-pricing-head-shape" />
                    </div>

                    <div className="st-pricing-feature">
                      <h2 className="st-pricing-feature-title">Hemoglobin Test</h2>
                      <ul className="st-pricing-feature-list st-mp0">
                        <li>
                          <i className="fas fa-check" />
                          First Description
                ...
                <div className="slick-slide-in">
                  <div className="st-pricing-table st-style1">
                    <div className="st-pricing-head">
                      <h2 className="st-price">$89</h2>
                      <img src="/img/shape/price-shape.svg" alt="shape" className="st-pricing-head-shape" />
                    </div>

                    <div className="st-pricing-feature">
                      <h2 className="st-pricing-feature-title">Homocysteine</h2>
                      <ul className="st-pricing-feature-list st-mp0">
                        <li>
                          <i className="fas fa-check" />
                          First Description
      ...
      <section className="st-faq-wrap st-shape-wrap">
        <div className="st-shape5">
          <img src="/img/shape/faq-bg.svg" alt="shape1" />
        </div>
        <div className="st-height-b120 st-height-lg-b80" />
        <div className="container">
          <div className="row">
            <div className="col-lg-6">
              <div className="st-vertical-middle">
                <div className="st-vertical-middle-in">
                  <div className="st-faq-img">
                    <img src="/img/faq-img.png" alt="Faq Image" />
                  </div>
                </div>
              </div>
              <div className="st-height-b0 st-height-lg-b30" />
            ...
            <div className="col-lg-6">
              <h2 className="st-accordian-heading">Just Answer the Questions</h2>
              <div className="st-accordian-wrap">
                <div className="st-accordian active ">
                  <div className="st-accordian-title">
                    What is Medi solution?
                    <span className="st-accordian-toggle fa fa-angle-down" />
                  </div>
                  <div className="st-accordian-body">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
                </div>

                <div className="st-accordian">
                  <div className="st-accordian-title">
      ...
      <section className="st-news-letter-section st-dynamic-bg st-bg" data-src="/img/news-letter-bg.png">
        <div className="container">
          <div className="st-section-heading st-style1">
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="st-news-letter">
                <form className="mailchimp st-news-letter-form" action="https://storerepublic.us12.list-manage.com/subscribe/post?u=d227d8d335060b093084903d0&id=9ba078ceb0">
                ...
                <div className="st-news-letter-number">(+01) - 234 567 890</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="blog">
        ...
        <div className="container">
          <div className="st-section-heading st-style1">
            <h2 className="st-section-heading-title">Latest News</h2>
            <div className="st-seperator">
              <div className="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" />
              <div className="st-seperator-center">
                <img src="/img/icons/4.png" alt="icon" />
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="st-post st-style3">
                <a href="blog-details-right-sidebar.html" className="st-post-thumb st-link-hover-wrap st-zoom">
                  <img className="st-zoom-in" src="/img/blog1.jpg" alt="blog1" />
                  <span className="st-link-hover">
                    <i className="fas fa-link" />
                  </span>
                </a>
                <div className="st-post-info">
                  <h2 className="st-post-title">
                    <a href="blog-details-right-sidebar.html">Working in emergency medicine</a>
                  </h2>
                  <div className="st-post-meta">
                    <span className="st-post-date">Aug 21, 2020</span>
                    <span>
                      Posted by:
                      <a href="#" className="st-post-avatar">
                        <span className="st-post-avatar-text"> James Lewis</span>
                      </a>
                    </span>
                  </div>
                  <div className="st-post-text">Lorem Ipsum is simply dummy text of the print ing and typesetting industry. lorem Ipsum the industry's standard dummy text.</div>
                </div>
                <div className="st-post-footer">
                  <a href="blog-details-right-sidebar.html" className="st-btn st-style2 st-color1 st-size-medium">
                    Read More
                  </a>
                </div>
              </div>
            ...
            <div className="col-lg-4">
              <div className="st-post st-style3">
                <a href="blog-details-right-sidebar.html" className="st-post-thumb st-link-hover-wrap st-zoom">
                  <img className="st-zoom-in" src="/img/blog2.jpg" alt="blog1" />
                  <span className="st-link-hover">
                    <i className="fas fa-link" />
                  </span>
                </a>
                <div className="st-post-info">
                  <h2 className="st-post-title">
                    <a href="blog-details-right-sidebar.html">Individual treatment &amp; assistance</a>
                  </h2>
                  <div className="st-post-meta">
                    <span className="st-post-date">Aug 22, 2020</span>
                    <span>
                      Posted by:{' '}
                      <a href="#" className="st-post-avatar">
                        <span className="st-post-avatar-text"> William Juarez</span>
                      </a>
                    </span>
                  </div>
                  <div className="st-post-text">Lorem Ipsum is simply dummy text of the print ing and typesetting industry. lorem Ipsum the industry's standard dummy text.</div>
            ...
            <div className="col-lg-4">
              <div className="st-post st-style3">
                <a href="blog-details-right-sidebar.html" className="st-post-thumb st-link-hover-wrap st-zoom">
                  <img className="st-zoom-in" src="/img/blog3.jpg" alt="blog1" />
                  <span className="st-link-hover">
                    <i className="fas fa-link" />
                  </span>
                </a>
                <div className="st-post-info">
                  <h2 className="st-post-title">
                    <a href="blog-details-right-sidebar.html">Child’s first hospital visit</a>
                  </h2>
                  <div className="st-post-meta">
                    <span className="st-post-date">Aug 23, 2020</span>
                    <span>
                      Posted by:
                      <a href="#" className="st-post-avatar">
                        <span className="st-post-avatar-text"> Albert Brian</span>
                      </a>
                    </span>
                  </div>
                  <div className="st-post-text">Lorem Ipsum is simply dummy text of the print ing and typesetting industry. lorem Ipsum the industry's standard dummy text.</div>
      ...
      <div className="st-gray-bg">
        ...
        <div className="container">
          <div className="st-slider st-style2 st-pricing-wrap">
            <div className="slick-container" data-autoplay={0} data-loop={1} data-speed={600} data-center={0} data-slides-per-view="responsive" data-xs-slides={1} data-sm-slides={2} data-md-slides={3} data-lg-slides={4} data-add-slides={5}>
              <div className="slick-wrapper">
                <div className="slick-slide-in">
                  <div className="st-logo-carousel st-style1 st-orange-box">
                    <img src="/img/client1.png" alt="client1" />
                  </div>
                </div>

                <div className="slick-slide-in">
                  <div className="st-logo-carousel st-style1 st-blue-box">
                    <img src="/img/client2.png" alt="client2" />
                  </div>
                </div>

                <div className="slick-slide-in">
                  <div className="st-logo-carousel st-style1 st-red-box">
                    <img src="/img/client3.png" alt="client3" />
                  </div>
                </div>

                <div className="slick-slide-in">
                  <div className="st-logo-carousel st-style1 st-green-box">
                    <img src="/img/client4.png" alt="client4" />
                  </div>
                </div>

                <div className="slick-slide-in">
                  <div className="st-logo-carousel st-style1 st-dip-blue-box">
                    <img src="/img/client5.png" alt="client5" />
                  </div>
                </div>
      ...
      <section className="st-shape-wrap" id="contact">
        <div className="st-shape1">
          <img src="/img/shape/contact-shape1.svg" alt="shape1" />
        </div>
        <div className="st-shape2">
          <img src="/img/shape/contact-shape2.svg" alt="shape2" />
        </div>
        <div className="st-height-b120 st-height-lg-b80" />
        <div className="container">
          <div className="st-section-heading st-style1">
            <h2 className="st-section-heading-title">Stay connect with us</h2>
            <div className="st-seperator">
              <div className="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" />
              <div className="st-seperator-center">
                <img src="/img/icons/4.png" alt="icon" />
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <div id="st-alert" />
              <form action="assets/php/mail.php" className="row st-contact-form st-type1" method="post" id="contact-form">
                <div className="col-lg-6">
                  <div className="st-form-field st-style1">
                    <label>Full Name</label>
                ...
                <div className="col-lg-12">
                  <div className="st-form-field st-style1">
                    ...
                    <textarea cols={30} rows={10} id="msg" name="msg" placeholder="Write something here..." required="" defaultValue={''} />
                  </div>
                </div>
                ...
                <div className="col-lg-12">
                  <div className="text-center">
                    ...
                    <button className="st-btn st-style1 st-color1 st-size-medium" type="submit" id="submit" name="submit">
                      Send message
                    </button>
                  </div>
                </div>
      ...
      <div className="st-google-map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d96652.27317354927!2d-74.33557928194516!3d40.79756494697628!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c3a82f1352d0dd%3A0x81d4f72c4435aab5!2sTroy+Meadows+Wetlands!5e0!3m2!1sen!2sbd!4v1563075599994!5m2!1sen!2sbd" allowFullScreen="" />
      </div>
    </div>

    <footer className="st-site-footer st-sticky-footer st-dynamic-bg" data-src="/img/footer-bg.png">
            ...
            <div className="col-lg-3">
              <div className="st-footer-widget">
                <div className="st-text-field">
                  <img src="/img/footer-logo.png" alt="Nischinto" className="st-footer-logo" />
                  <div className="st-height-b25 st-height-lg-b25" />
                  <div className="st-footer-text">Lorem ipsum dolor sit consectet adipisicing sed do eiusmod temp incididunt ut labore. Lorem Ipsum is simply dummy.</div>
                  <div className="st-height-b25 st-height-lg-b25" />
            ...
            <div className="col-lg-3">
              <div className="st-footer-widget">
                ...
                <ul className="st-footer-contact-list st-mp0">
                  <li>
                    <span className="st-footer-contact-title">Address:</span> 1223 Fulton Street San Diego CA 941-23 USA
                  </li>
                  <li>
                    <span className="st-footer-contact-title">Email:</span> nischinto@Gmail.Com
                  </li>
                  <li>
                    <span className="st-footer-contact-title">Phone:</span> (+01) - 234 567 890 <br />
                    (+01) - 345 678 901
                  </li>
                </ul>
              </div>
        ...
        <div className="container">
          <div className="st-copyright-in">
            <div className="st-left-copyright">
              <div className="st-copyright-text">Copyright 2021. Design by Laralink</div>
            </div>
    ...
    <div className="st-video-popup">
      <div className="st-video-popup-overlay" />
      <div className="st-video-popup-content">
        <div className="st-video-popup-layer" />
        <div className="st-video-popup-container">
          ...
          <div className="st-video-popup-close" />
        </div>
      </div>
    </div>
  </>
