  ...
  return (
    <div className="flex flex-col items-start w-full mt-1 md:mt-5">
      ...
      <div className="relative w-full">
        {/* input */}
        <input disabled={label == 'Date' ? true : disabled} value={value} type={showPassword ? 'text' : type} name={name} id={id} placeholder={placeholder} onChange={onChange} required className="w-full border border-primary-300 text-primary-900 text-xs md:text-sm rounded-sm md:rounded-md md:rounded-lg focus:ring-primary-500 focus:border-primary-500 p-0.5 md:p-2.5 " />
