...
<body>
  ...
  <div class="st-content">
    <div class="st-page-heading st-dynamic-bg" data-src="assets/img/hero-bg2.jpg">
      <div class="container">
        <div class="st-page-heading-in text-center">
          <h1 class="st-page-heading-title">This disease occurs when nerve cells <br>or neurons in a certain.</h1>
          ...
          <div class="comments-area">
            ...
            <div class="comment-respond">
              ...
              <form method="post" class="comment-form">
                ...
                <p class="form-submit">
                  <button type="submit" class="st-btn st-style1 st-color1 st-size-medium">SEND MESSAGE</button>
                </p>
              </form>
            </div><!-- .comment-respond -->
          </div>
