...
<body>
  ...
  <div class="st-content">
    <div class="st-page-heading st-size-md st-style1 st-dynamic-bg" data-src="assets/img/hero-bg5.jpg">
      <div class="container">
        <div class="st-page-heading-in text-center">
          <h1 class="st-page-heading-title">Stay connect with us</h1>
          <div class="st-page-heading-subtitle">Our dedicated team is available 20/7.</div>
        </div>
      </div>
    </div><!-- .st-page-heading -->
