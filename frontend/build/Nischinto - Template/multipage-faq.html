...
<body>
    ...
    <div class="st-top-header">
      <div class="container">
        <div class="st-top-header-in">
          <a class="st-site-branding" href="multipage-index.html"><img src="assets/img/logo.png" alt="Nischinto"></a>
          ...
          <div class="st-main-header-left">
            <div class="st-nav">
              <ul class="st-nav-list">
                <li><a href="multipage-index.html">Home</a></li>
                <li><a href="multipage-about.html">About</a></li>
                <li><a href="multipage-gallery.html">Gallery</a></li>
                <li><a href="multipage-pricing.html">Pricing</a></li>
                <li class="menu-item-has-children"><a href="multipage-blog.html">Blog</a>
                  <ul>
  ...
  <div class="st-content">
    <div class="st-page-heading st-size-md st-style1 st-dynamic-bg" data-src="assets/img/hero-bg8.jpg">
      <div class="container">
        <div class="st-page-heading-in text-center">
          <h1 class="st-page-heading-title">FAQ</h1>
          <div class="st-page-heading-subtitle">Frequently ask question</div>
        </div>
      </div>
    </div><!-- .st-page-heading -->
    ...
    <section class="st-faq-wrap st-shape-wrap">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <h2 class="st-accordian-heading">Related to our Doctor</h2> 
            <div class="st-accordian-wrap">
              <div class="st-accordian active ">
                ...
                <div class="st-accordian-body">No, we have Electronic Healthcare Records (EHR) for our patients. This system will allow your information to be available at all of our clinic locations, further improving efficiency and quality of the healthcare you receive.</div>
              </div><!-- .st-accordian -->
              <div class="st-accordian">
                ...
                <div class="st-accordian-body">Yes. As a service to our patients, primary insurance is billed. We have recently enhanced our system to accommodate automatic billing of secondary insurance. Please be sure to keep us informed of your insurance coverage.</div>
              </div><!-- .st-accordian -->
              <div class="st-accordian">
                <div class="st-accordian-title">
                ...
                <div class="st-accordian-body">Please call your physician’s office as soon as you realize you will not be able to keep your appointment. We prefer all cancellations be made at least 24 hours prior to your scheduled appointment time. This will allow us to give another patient the opportunity to be seen.</div>
              </div><!-- .st-accordian -->
              <div class="st-accordian">
                <div class="st-accordian-title">
                  If I call with a question for the nurse or doctor?
                  <span class="st-accordian-toggle fa fa-angle-down"></span>
                </div>
                <div class="st-accordian-body">Our physicians and nurses are with patients throughout the day, so it is usually not possible for them to immediately answer phone calls. We will return your call as soon as possible. To help us get back to you quickly leave us your full name, date of birth, reason for the call and current phone number.</div>
              </div><!-- .st-accordian -->
              <div class="st-accordian">
                <div class="st-accordian-title">
                ...
                <div class="st-accordian-body">When you receive the call back, the on-call physician will instruct you as to whether you need to go to an emergency room, urgent care clinic or if the problem can wait for an appointment the next day. Have your prescription medication information available during this call.</div>
              </div><!-- .st-accordian -->
            </div><!-- .st-accordian-wrap -->
          </div>
          <div class="col-lg-6">
            <h2 class="st-accordian-heading">Related to our Service</h2>
            <div class="st-accordian-wrap">
              <div class="st-accordian active ">
                <div class="st-accordian-title">
