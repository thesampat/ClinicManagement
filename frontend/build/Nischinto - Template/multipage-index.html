        ...
        <div class="slick-wrapper">
          <div class="slick-slide-in">
            <div class="st-hero st-style1 st-size1">
              <div class="st-hero-bg st-dynamic-bg st-bg" data-src="assets/img/hero-bg13.jpg"></div>
              <div class="container">
                <div class="st-hero-text">
                  ...
                  <div class="st-hero-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br>Tempor incididunt ut labore et dolore magna.</div>
                  <div class="st-hero-btn-group">
                    <a href="#appointment" class="st-btn st-style1 st-size-medium st-color1 st-smooth-move">Appointment</a>
                    <a href="about.html" class="st-btn st-style1 st-size-medium st-color3">About Us</a>
                  </div>
          ...
          <div class="slick-slide-in">
            <div class="st-hero st-style1 st-size1">
              <div class="st-hero-bg st-dynamic-bg st-bg" data-src="assets/img/hero-bg6.jpg"></div>
              <div class="container">
                <div class="st-hero-text">
                  <h1 class="st-hero-title">
